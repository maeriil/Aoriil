...
result_img = textdetection._draw_detect_borders(easyocr_img, easyocr_sections)
text_sections = []
...
for section in merged_sections:
    ...
    box = [
        section.start_pos,
        [section.end_pos[0], section.start_pos[1]],
        section.end_pos,
        [section.start_pos[0], section.end_pos[1]],
    ]
    coreimage.replace_image_section(
        destination_image, processed_cropped_section, box
    )
